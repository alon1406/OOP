...
public class FactoryProduct {
    ...
    public Product createProduct(String productName, double productPrice, int categoryIndex, double specialPackagePrice) {

         
         if(specialPackagePrice != 0  )
         
         return new ProductSpecialPackage(productName, productPrice, Category.values()[categoryIndex], specialPackagePrice);
         
         else {
       	  return new Product(productName, productPrice, Category.values()[categoryIndex - 1]);
         }
